...
def scrape_info():
    ...
    html_table = table[0].to_html(index=False,header=False)
    html_table
...
#scrape will return 7 items, so when assigning to scrape, it MUST be a 7 variable assignment 
    return news_title, news_body, image_url, featured_image_url, mars_weather, html_table, hemisphere_range_urls